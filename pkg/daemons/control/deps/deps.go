...
func CreateRuntimeCertFiles(config *config.Server) {
...
func GenServerDeps(config *config.Server) error {
	runtime := config.Runtime
...
func getNodePass(config *config.Server, serverPass string) string {
...
func genUsers(config *config.Server) error {
	runtime := config.Runtime
...
func genEncryptedNetworkInfo(controlConfig *config.Server) error {
...
func getServerPass(passwd *passwd.Passwd, config *config.Server) (string, error) {
	var (
		err error
	)
...
func genCerts(config *config.Server) error {
...
func genClientCerts(config *config.Server) error {
	runtime := config.Runtime
...
func genServerCerts(config *config.Server) error {
	runtime := config.Runtime
...
func genETCDCerts(config *config.Server) error {
	runtime := config.Runtime
...
func genRequestHeaderCerts(config *config.Server) error {
	runtime := config.Runtime
...
func createServerSigningCertKey(config *config.Server) (bool, error) {
	runtime := config.Runtime
...
func genEncryptionConfigAndState(controlConfig *config.Server) error {
	runtime := controlConfig.Runtime

...
// 	testutil "github.com/rancher/rke2/tests/util"
...
// func generateTestConfig() *config.Server {
// 	agentReady := make(chan struct{})
// 	close(agentReady)
// 	criticalControlArgs := config.CriticalControlArgs{
// 		ClusterDomain:  "cluster.local",
// 		ClusterDNSIP:   net.ParseIP("10.43.0.10"),
...
// 		name     string
// 		args     args
// 		setup    func(*config.Server) error
// 		teardown func(*config.Server) error
// 		want     bool
// 		wantErr  bool
// 	}{
// 		{

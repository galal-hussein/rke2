...
func doAuth(roles []string, serverConfig *config.Server, next http.Handler, rw http.ResponseWriter, req *http.Request) {
	switch {
...
func authMiddleware(serverConfig *config.Server, roles ...string) mux.MiddlewareFunc {
